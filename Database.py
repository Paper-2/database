...
"""Our Database class contains all of the recipes that are used for
user interaction in our GUI"""
...
class Database:
    ...
    def __create_table(self):
        ...
        try:
            # Italian Dishes
            self.cursor.execute('INSERT INTO Cuisines (cui_type, rec_name, '
                                'ingredients_list, link) VALUES '
                                '(?, ?, ?, ?)',
                                ('Italian', 'Air Fryer Chicken Parmesan',
                                 '2 boneless skinless chicken breasts, kosher salt, '
                                 'black pepper, '
                                 'all-purpose flour, eggs,'
                                 'panko breadcrumbs, Parmesan cheese, olive oil, '
                                 'crushed red pepper, '
                                 'garlic powder, marinara'
                                 ' sauce, mozzarella cheese',
                                 'https://www.allrecipes.com/air-fryer-chicken-parmesan-recipe-8698442'))

            self.cursor.execute('INSERT INTO Cuisines (cui_type, rec_name, '
                                'ingredients_list, link)'
                                ' VALUES (?, ?, ?, ?)',
                                ('Italian', 'Pizza on the Grill',
                                 'warm water, active dry yeast, white sugar, all-purpose flour,'
                                 'olive oil, kosher salt,'
                                 'garlic minced, fresh basil, tomatoes, black olives, '
            ...
            self.cursor.execute('INSERT INTO Cuisines (cui_type, rec_name, '
                                ...
                                ('Italian', 'World\'s Best Lasagna',
                                 'Italian sausage, ground beef, minced onion, garlic, '
                                 'crushed tomatoes, tomato sauce,'
                                 'tomato''paste, water, sugar, parsley, basil, salt, '
                                 'Italian seasoning, fennel seeds,'
                                 'black pepper, lasagna noodles, ricotta cheese, egg, '
            ...
            self.cursor.execute('INSERT INTO Cuisines (cui_type, rec_name, '
                                ...
                                ('Italian', 'Shrimp Scampi with Pasta',
                                 'linguine pasta, butter, extra-virgin olive oil, '
                                 'shallots, garlic, red pepper flakes,'
                                 'shrimp, kosher salt, white wine, lemon, parsley',
            ...
            self.cursor.execute('INSERT INTO Cuisines (cui_type, rec_name, '
                                ...
                                ('Italian', 'The Best Meatballs',
                                 ...
                                 'Romano cheese, eggs, garlic, parsley, '
                                 'stale bread,'
                                 'water, olive oil',
            ...
            self.cursor.execute('INSERT INTO Cuisines (cui_type, rec_name, '
                                ...
                                ('Indian', 'Butter Chicken (Murgh Makhani)',
                                 'garam masala, tandoori masala, Madras curry powder, '
                                 'cumin, cardamom, cayenne pepper,'
                                 'chicken thighs, butter, onion, garlic, lemon juice, '
                                 'ginger, tomato puree, yogurt, cashews,'
                                 'cilantro',
            ...
            self.cursor.execute('INSERT INTO Cuisines (cui_type, rec_name, '
                                ...
                                ('Indian', 'Chicken Tikka Masala',
                                 'yogurt, lemon juice, cumin, cinnamon, '
                                 'cayenne pepper, black pepper, ginger, '
                                 'chicken '
                                 'breasts, garlic, jalapeno, paprika, '
                                 'tomato sauce, heavy cream, cilantro',
            ...
            self.cursor.execute('INSERT INTO Cuisines (cui_type, rec_name, '
                                ...
                                ('Indian', 'Red Lentil Curry',
                                 'red lentils, water, vegetable oil, onion, '
                                 'curry paste, curry powder, turmeric, cumin,'
                                 'chili powder, salt, sugar, garlic, ginger, tomato puree',
            ...
            self.cursor.execute('INSERT INTO Cuisines (cui_type, rec_name, '
                                ...
                                ('Indian', 'Green Onion Garlic Naan Bread',
                                 'bread flour, kosher salt, baking powder, '
                                 'Greek yogurt, garlic, green onions,'
                                 'melted butter',
            ...
            self.cursor.execute('INSERT INTO Cuisines (cui_type, rec_name, '
                                ...
                                ('Indian', 'Golden Butter Rice',
                                 'butter, ginger, turmeric, cayenne pepper, '
                                 'brown sugar, salt, basmati rice, '
                                 'water, walnuts,'
                                 'green onions',
            ...
            self.cursor.execute('INSERT INTO Cuisines (cui_type, rec_name, '
                                ...
                                ('Mexican', 'The Best Chimichangas',
                                 'kosher salt, black pepper, garlic powder, chicken breasts, '
                                 'olive oil, onion, garlic,'
                                 'ancho chili powder, cumin, water, chicken bouillon, '
                                 'green chiles, all-purpose flour,'
                                 'peanut oil, flour Tortillas, refried beans, pepper jack cheese',
                                 'https://www.allrecipes.com/the-best-chimichangas-recipe-8637540'))

            self.cursor.execute('INSERT INTO Cuisines (cui_type, rec_name, ingredients_list, link) '
                                'VALUES (?, ?, ?, ?)',
                                ('Mexican', 'Traditional Mexican Street Tacos',
                                 'corn Tortillas, cooked chicken, cilantro, white onion, '
                                 'guacamole, lime',
            ...
            self.cursor.execute('INSERT INTO Cuisines (cui_type, rec_name, '
                                ...
                                ('Mexican', 'Enchiladas Verdes',
                                 'tomatillos, serrano peppers, garlic, vegetable oil, '
                                 'corn Tortillas, water, chicken'
                                 'bouillon, shredded chicken, lettuce, cilantro, crema, cotija cheese',
                                 'https://www.allrecipes.com/recipe/213700/enchiladas-verdes/'))

            self.cursor.execute('INSERT INTO Cuisines (cui_type, rec_name, ingredients_list, link) '
                                'VALUES (?, ?, ?, ?)',
                                ('Mexican', 'Beef Tamales',
                                 'boneless chuck roast, garlic, dried corn husks, '
                                 'dried ancho chiles, vegetable oil,'
                                 'all-purpose flour, beef broth, garlic, oregano, '
                                 'cumin seeds, ground cumin,'
                                 'red pepper flakes, vinegar, lard, masa harina',
                                 'https://www.allrecipes.com/recipe/34759/beef-tamales/'))

            self.cursor.execute('INSERT INTO Cuisines (cui_type, rec_name, ingredients_list, link) '
                                'VALUES (?, ?, ?, ?)',
                                ('Mexican', 'Fabulous Wet Burritos',
                                 'ground beef, onion, garlic, cumin, salt, pepper, '
                                 'refried beans, green chile peppers,'
                                 'chili, tomato soup, enchilada sauce, flour Tortillas, '
                                 'lettuce, tomatoes, Mexican'
                                 'cheese blend, green onions',
            ...
            self.cursor.execute('INSERT INTO Cuisines (cui_type, rec_name, ingredients_list, link) '
                                ...
                                ('Japanese', 'Chicken Katsu',
                                 'chicken breasts, salt, pepper, all-purpose flour, egg,'
                                 ' panko bread crumbs, oil for frying',
            ...
            self.cursor.execute('INSERT INTO Cuisines (cui_type, rec_name, '
                                ...
                                ('Japanese', 'Japanese-Style Rolled Omelet (Tamagoyaki)',
                                 'eggs, water, soy sauce, mirin, kosher salt, sugar, '
                                 'cayenne pepper, sesame oil,'
                                 'vegetable oil, furikake',
                                 'https://www.allrecipes.com/japanese-style-rolled-omelet-tamagoyaki-recipe-8644676'))

            self.cursor.execute('INSERT INTO Cuisines (cui_type, rec_name, ingredients_list, link) '
                                'VALUES (?, ?, ?, ?)',
                                ('Japanese', 'Onigiri (Japanese Rice Balls)',
                                 'short-grain white rice, water, salt, bonito '
                                 'shavings, nori, sesame seeds',
            ...
            self.cursor.execute('INSERT INTO Cuisines (cui_type, rec_name, '
                                ...
                                ('Japanese', 'Spicy Tuna Sushi Roll',
                                 'glutinous white rice, water, rice vinegar, tuna, mayonnaise, '
                                 'chili powder, wasabi paste,'
                                 'nori, cucumber, carrot, avocado',
            ...
            self.cursor.execute('INSERT INTO Cuisines (cui_type, rec_name, ingredients_list, link) '
                                ...
                                ('German', 'German Pork Chops and Sauerkraut',
                                 'pork chops, sauerkraut, red apple, onion, '
            ...
            self.cursor.execute('INSERT INTO Cuisines (cui_type, rec_name, ingredients_list, link) '
                                ...
                                ('German', 'Creamy Dill German Potato Salad',
                                 'yellow potatoes, mayonnaise, Greek yogurt, dill pickle brine,'
                                 'Dijon mustard, eggs, onion,'
                                 'dill pickles',
            ...
            self.cursor.execute('INSERT INTO Cuisines (cui_type, rec_name, ingredients_list, link) '
                                ...
                                ('German', 'Wiener Schnitzel',
                                 'veal cutlets, all-purpose flour, eggs, Parmesan cheese,'
                                 ' milk, parsley, salt, pepper,'
                                 'nutmeg, bread crumbs, butter, lemon',
            ...
            self.cursor.execute('INSERT INTO Cuisines (cui_type, rec_name, ingredients_list, link)'
                                ...
                                ('German', 'German Zwiebelkuchen (Onion Pie)',
                                 'onions, bacon, sour cream, eggs, all-purpose flour, salt, caraway seed, '
                                 'pastry for pie',
            ...
            self.cursor.execute('INSERT INTO Cuisines (cui_type, rec_name, ingredients_list, link) '
                                ...
                                ('German', 'German Currywurst',
                                 'tomato sauce, kielbasa, chili sauce, onion salt, white sugar, '
    ...
    def search_recipes(self, recipe_name, ingredients="", cuisine_selected=""):
        ...
        Returns:
            list[tuple]: A list of tuples where each tuple contains the cuisine type, recipe name, ingredients list,
            and link.
            """
