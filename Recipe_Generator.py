...
try:
    ...
    cursor.execute('''INSERT INTO Cuisines (cui_type, rec_name, ingredients_list, link) VALUES ('Italian', 'Worlds Best Lasagna',
    ...
    cursor.execute('''INSERT INTO Cuisines (cui_type, rec_name, ingredients_list, link) VALUES ('Chinese', 'Baked Sweet And Sour Chicken', 
    ...
    cursor.execute('''INSERT INTO Cuisines (cui_type, rec_name, ingredients_list, link) VALUES ('Chinese', "Sheet Pan General Tso's Chicken and Broccoli", 
    ...
    # Extend the database with a table for custom cuisines
    cursor.execute('''CREATE TABLE IF NOT EXISTS CustomCuisines
    (cui_type TEXT, rec_name TEXT, ingredients_list TEXT, link TEXT)
    ''')
...
def match_recipes(selected_cuisine, user_ingredients):
    ...
    normalized_user_ingredients = [normalize_ingredient(ingredient) for ingredients in user_ingredients.values() for
