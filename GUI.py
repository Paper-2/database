...
class Color(QWidget):
    ...
    def __init__(self, color):
        ...
        # Setup the favorites button and connect it to the display function
        self.favorites_bar = QPushButton("Favorites")
        self.favorites_bar.clicked.connect(self.show_favorites)  # Connect to the display favorites function
        self.main_layout.addWidget(self.favorites_bar)

    # Function to display favorite recipes
    def show_favorites(self):
        if self.favorites:
            self.update_recipe_list(self.favorites)  # Update the UI with favorite recipes
        else:
            no_favorites_label = QLabel("No favorite recipes yet.")
            self.sub_layout.addWidget(no_favorites_label)
...
class recipe_widget:
    ...
    def horizontal_item_widget(self):
        ...
        favorite_button.clicked.connect(self.add_to_favorites)  # Mark the recipe as a favorite
    ...
    def add_to_favorites(self):
        self.window.add_to_favorites(self.recipe)
